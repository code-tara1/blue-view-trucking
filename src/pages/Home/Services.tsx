    ...
    >
      <Box maxW={"1440px"} mx={"auto"} w={"full"}>
        <Flex
          ...
          align={"center"}
          w={"full"}
          maxW={{ base: "full", sm: "90vw", lg: "80vw" }}
          mx={"auto"}
          flexDir={"column"}
          gap={4}
          ref={ref}
        >
          ...
          >
            ...
            >
              ...
              world class logistical solutions. We offer package delivery,
              hotshot delivery and more. We also offer personal loans services.
              For more information check our services page or call us directly.
            </Text>
          </Stack>
          <Box
            opacity={inView ? 1 : 0}
